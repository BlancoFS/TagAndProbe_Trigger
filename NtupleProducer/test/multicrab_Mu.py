...
dataset = {
   ...
   # 2024
   "Run2024C_Muon0": "/Muon0/Run2024C-2024CDEReprocessing-v1/MINIAOD",
   "Run2024C_Muon1": "/Muon1/Run2024C-2024CDEReprocessing-v1/MINIAOD",
   "Run2024D_Muon0": "/Muon0/Run2024D-2024CDEReprocessing-v1/MINIAOD",
   "Run2024D_Muon1": "/Muon1/Run2024D-2024CDEReprocessing-v1/MINIAOD",
   "Run2024E_Muon0": "/Muon0/Run2024E-2024CDEReprocessing-v1/MINIAOD",
   "Run2024E_Muon1": "/Muon1/Run2024E-2024CDEReprocessing-v1/MINIAOD",
   "Run2024F_Muon0": "/Muon0/Run2024F-PromptReco-v1/MINIAOD",
   "Run2024F_Muon1": "/Muon1/Run2024F-PromptReco-v1/MINIAOD",
   "Run2024G_Muon0": "/Muon0/Run2024G-PromptReco-v1/MINIAOD",
   "Run2024G_Muon1": "/Muon1/Run2024G-PromptReco-v1/MINIAOD", 
   "Run2024H_Muon0": "/Muon0/Run2024H-PromptReco-v1/MINIAOD",
   "Run2024H_Muon1": "/Muon1/Run2024H-PromptReco-v1/MINIAOD",
   "Run2024Iv1_Muon0": "/Muon0/Run2024I-PromptReco-v1/MINIAOD",
   "Run2024Iv1_Muon1": "/Muon1/Run2024I-PromptReco-v1/MINIAOD",
   "Run2024Iv2_Muon0": "/Muon0/Run2024I-PromptReco-v2/MINIAOD",
   "Run2024Iv2_Muon1": "/Muon1/Run2024I-PromptReco-v2/MINIAOD",
}
lumisPerJob = {
   'Run2022B' :        100,
   'Run2022C1':        100,
   ...
   "Run2024H_Muon0": 100,
   "Run2024H_Muon1": 100,
   "Run2024Iv1_Muon0": 100,
   "Run2024Iv1_Muon1": 100,
   "Run2024Iv2_Muon0": 100,
   "Run2024Iv2_Muon1": 100,
}
listOfSamples = [
   #'Run2022B',
   #'Run2022C1',
...
if __name__ == '__main__':
   ...
   config.General.workArea = 'crab_TrigEff_HWW_Muon_2024'
   config.General.transferLogs = False

   config.JobType.pluginName = 'Analysis'
   config.JobType.psetName = 'runNtupler_Mu.py'
   ...
   config.Data.outLFNDirBase = '/store/group/phys_higgs/cmshww/calderon/TriggerEff_RunIII_Summer24/TrigEff_HWW_Muon_2024'
